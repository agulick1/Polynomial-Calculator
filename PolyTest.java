...
public class PolyTest{
    ...
    public void additionalTests(){
        //tests division by decimal
        Poly p0 = new Poly(3, 2);       //3x^2
        Poly p1 = new Poly(0.5, 0);     //.5
        Poly p2 = p0.divide(p1);        //3x^2/.5 = 6x^2
        Poly p3 = new Poly(6,2);        //6x^2
        assertEquals("3x^2 / .5 != 6x^2", p2, p3);
        
        //tests multiplication by poly with higher degree
        Poly p10 = new Poly(2,1);       //2x
        Poly p11 = new Poly(7,5);       //7x^5
        Poly p12 = p10.multiply(p11);   //2x*7x^5 = 14x^6
        Poly p13 = new Poly(14,6);
        assertEquals("2x * 7x^5 != 14x^6", p12, p13);
        
        //tests remainder in division resulting in null
        Poly p20 = new Poly(3,3);           //3x^3
        Poly p21 = p20.add(new Poly(3,0));  //3x^3+3
        Poly p22 = new Poly (1,1);          //x
        Poly p23 = p21.divide(p22);         //3x^3 + 3 / x = null
        assertEquals("3x^3 + 3 / x != null", p23, null);
        
        //tests division by negative
        Poly p30 = new Poly(3, 2);       //3x^2
        Poly p31 = new Poly(-1, 1);      //-x
        Poly p32 = p30.divide(p31);        //3x^2/-x = -3x
        Poly p33 = new Poly(-3,1);        //6x^2
        assertEquals("3x^2/-x != -3x", p32, p33);
        
        //tests subtraction of larger poly
        Poly p40 = new Poly(3, 1);       //3x
        Poly p41 = new Poly(2, 5);      //2x^5
        Poly p42 = p40.subtract(p41);        //3x - 2x^5 = -2x^5 + 3x
        Poly p43 = (new Poly(-2, 5)).add(p40);        //-2x^5 + 3x
        assertEquals("3x - 2x^5 != -2x^5 + 3", p42, p43);
